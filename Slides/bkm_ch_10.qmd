...
### *Multifactor* models can better describe uncertainty in asset returns by allowing two or more systematic risk factors, as well as firm-specific surprises {.allowframebreaks}
...
### Researchers have added *many*, *many* factors to the FF three-factor model {.allowframbreaks}
