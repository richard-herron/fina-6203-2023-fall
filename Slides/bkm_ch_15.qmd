...
- Bond value should be the sum of the values of each bond cash flow
...
### Yield curve reflects expectations of future short rates, but also other factors such as liquidity premiums {.allowframebreaks}
...
- An upward-sloping yield curve has two interpretations:
  - Investors expect rates to rise (i.e., $E(r_n)$ is high)
  - ***and/or***
