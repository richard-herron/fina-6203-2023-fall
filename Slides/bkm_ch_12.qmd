...
- Conventional finance
  ...
  - Therefore, resources are allocated efficiently
...
- Equity carve-outs
  - Examples: 3Com and Palm
    ...
    - However, Palm's share price was *higher* that 3Com's share price!
    - We can estiamte 3Com's *stub value* as 3Com's share price minus Palm's share price
    - 3Com had assets of $10 per share, so its stub value should have been at least $10
    - However, 3Com's estimated stub value was *negative* for more than two months!
...
### Behavioral finance explanations of efficient market anomalies do not always give guidance on how we can exploit them!
...
- Among financial economists:
  ...
  - Many are not convinced it indicts or refutes the EMH because risk-adjusted profits are small and fleeting
...
- Confidence index 
  ...
  - Ratio of the average yield on ten top-rated corporate bonds divided by the average yield on ten intermediate-grade corporate bonds
  - Ratio will always be less than one because intermediate-grade yields are always greater than top-rated yields
...
- Put/call ratio
  - Ratio of outstanding put options to outstanding call options, which is typically about 65%
  - Rising put/call ratio is taken as a sign of broad investor pessimism and a coming market decline
...
![Actual and simulated chagnes in weekly stock prices for 52 weeks [@bodie_investments_2023, Figure 12.7]](./Figures/bod12665_1207.png){height=75%}
