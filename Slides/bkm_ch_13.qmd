...
- The most common tests use a two-pass approach
	1. Use time-series returns to estimate the systematic risk ($\beta$)
...
- We add $\sigma^2(e_i)$ and estimate:
$$
...
- Pastor and Stambaugh:
	...
	- The original price change was a concession on the part of trade initiators who needed to offer/accept higher/lower purchase prices to complete their trade promptly
- Amihud:
...
- The illiquidity premium may be the same order of magnitude as the market risk premium
