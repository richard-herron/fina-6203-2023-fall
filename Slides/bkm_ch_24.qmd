...
![Excess returns for portfolios $P$ and $Q$ and the market index $M$ over 12 months [@bodie_investments_2023, Table 24.2]](./Figures/table_2402.png){height=75%}

![Performance statistics [@bodie_investments_2023, Table 24.3]](./Figures/table_2403.png){height=75%}
...
### Regardless of the performance measure, some funds will outperform their benchmarks in any year, and some will underperform {.allowframebreaks}
