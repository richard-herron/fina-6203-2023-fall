...
- There are two doubts about the conclusions of the identical input lists assumption
  1. Short-selling frictions limit checks on too-high prices; these short-selling frictions are:
    ...
    - Many investment companies prohibit short sales, as do some regulations
...
- Investors should be more concerned with the stream of consumption that wealth can buy for them than about the mean and variance of wealth during this period (assumption 1a)
...
- The CCAPM centers the CAPM directly on consumption so that the utility of an additional dollar of consumption today must equal the utility of the expected future consumption financed by investing that marginal dollar today
...
- Illiquidity can be measured in part by the discount from the fair market value a seller must accept if she must quickly sell the asset
...
### Portfolio theory and the CAPM are accepted tools in the practitioner community {.allowframebreaks}
