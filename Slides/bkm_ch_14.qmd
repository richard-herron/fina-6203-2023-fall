...
- Call provisions allow issuers to repurchase bonds at a specified *call price* before maturity 
	...
	- The option to call a bond is valuable *to the firm*, so firms typically issue callable bonds with higher coupon rates and promised yields than non-callable bonds
