...
- But, Eugene Fama's Ph.D. dissertation highlighted that stock prices should already reflect any information that could predict stock prices
...
$$
r_t = a + br_{Mt} + e_t \implies e_t = r_t - (a + b r_{Mt})
$$
...
- A cumulative abnormal return (CAR) sums abnormal returns $e_t$ over a period to capture the total firm-specific price change, reducing concerns about leakage and averaging out noise
...
- This definition of market efficiency is the one we care about!
...
### There is little evidence that professionally managed portfolios can consistently beat the market {.allowframebreaks}

![Consistency of Investments Results [@bodie_investments_2023, Table 11.1]](./Figures/table_1101.png){height=50%}

![Mutual fund alphas computer using a four-factor model of expected return, 1993--2007. (The best and worst 2.5% of observations are excluded from this distribution.) [@bodie_investments_2023, Figure 11.8]](./Figures/bod12665_1108.png){height=50%}
